    ...
    internal class Program : IProgram
    {
        ...
        private static void Main(string[] args)
        {
            try
            {
                ...
                ParserResult<object> results = parser.ParseArguments<VersionControlSettings, TestResults, AddPackage, RemovePackage, Wrapper, TestWrapper>(Core.Arguments);
                ...
                bool newResult = results.MapResult(
                    ...
                    (TestWrapper runner) => runner.CanExecute() && runner.Execute(),
                    _ => false);
