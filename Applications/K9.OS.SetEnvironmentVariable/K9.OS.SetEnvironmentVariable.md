...
| `USER-TARGET`   | The path to a file storing a comma-seperated list of user-level environmental variables.  |          |         |
...
| `SYSTEM-TARGET` | The path to a file storing a comma-seperated list of system-wide environmental variables. |          |         |